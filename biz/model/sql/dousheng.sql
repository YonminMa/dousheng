...
create table `user` (
                        ...
                        `avatar` varchar(128) not null default 'https://gravatar.zeruns.tech/avatar/' comment '头像',
                        `background_image` varchar(128) not null default 'https://i0.hdslb.com/bfs/space/cb1c3ef50e22b6096fde67febe863494caefebad.png@2560w_400h_100q_1o.webp' comment '用户个人页顶部大图',
                        `signature` varchar(128) not null default '这个人很神秘，什么都没有写' comment '个人简介',
